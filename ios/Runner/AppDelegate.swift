  ...
  override func application(
    ...
    didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?
     ...
     // GeneratedPluginRegistrant.register(withRegistry: self)
      ...
      let countHandlerEvent = FlutterEventChannel(name: "countHandlerEvent", binaryMessenger: controller.binaryMessenger)
      countHandlerEvent.setStreamHandler(CounterHandler())
